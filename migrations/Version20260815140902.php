 ...
 */
final class Version20260815140902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE observation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, observed_at DATE NOT NULL, type VARCHAR(255) NOT NULL, note CLOB DEFAULT NULL, height_cm INTEGER DEFAULT NULL, leaf_count INTEGER DEFAULT NULL, germinated_count INTEGER DEFAULT NULL, harvest_grams INTEGER DEFAULT NULL, created_at DATETIME NOT NULL, sowing_id INTEGER DEFAULT NULL, plot_id INTEGER NOT NULL, CONSTRAINT FK_C576DBE0392BF32A FOREIGN KEY (sowing_id) REFERENCES sowing (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C576DBE0680D0B01 FOREIGN KEY (plot_id) REFERENCES plot (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
